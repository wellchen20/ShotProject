...
public class Ut implements OpenStreetMapConstants, OpenStreetMapViewConstants {
	...
	public static File getRMapsProjectDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project", getRMapsMainDir(mCtx, "project").getAbsolutePath(), "");
	}

	public static File getRMapsProjectPublicDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_public", getRMapsMainDir(mCtx, "project/public").getAbsolutePath(), "");
	}

	public static File getRMapsRMapsProjectPrivateDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private", getRMapsMainDir(mCtx, "project/private").getAbsolutePath(), "");
	}
	
	public static File getRMapsProjectPrivatePointsDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_points", getRMapsMainDir(mCtx, "project/private/points").getAbsolutePath(), "");
	}
	
	public static File getRMapsProjectPrivatePointsInputDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_points_input", getRMapsMainDir(mCtx, "project/private/points/input").getAbsolutePath(), "");
	}

	public static File getRMapsProjectPrivatePointsOutputDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_points_output", getRMapsMainDir(mCtx, "project/private/points/output").getAbsolutePath(), "");
	}
	
	public static File getRMapsProjectPrivateTracksDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_tracks", getRMapsMainDir(mCtx, "project/private/tracks").getAbsolutePath(), "");
	}
	
	public static File getRMapsProjectPrivateTracksInputDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_tracks_input", getRMapsMainDir(mCtx, "project/private/tracks/input").getAbsolutePath(), "");
	}

	public static File getRMapsProjectPrivateTracksOutputDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_tracks_output", getRMapsMainDir(mCtx, "project/private/tracks/output").getAbsolutePath(), "");
	}
	
	public static File getRMapsProjectPrivateTasksDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_tasks", getRMapsMainDir(mCtx, "project/private/tasks").getAbsolutePath(), "");
	}
	
	public static File getRMapsProjectPrivateTasksInputDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_tasks_input", getRMapsMainDir(mCtx, "project/private/tasks/input").getAbsolutePath(), "");
	}

	public static File getRMapsProjectPrivateTasksOutputDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_tasks_output", getRMapsMainDir(mCtx, "project/private/tasks/output").getAbsolutePath(), "");
	}

	public static File getRMapsProjectPrivateAreaDir(final Context mCtx) {
		return getDir(mCtx, "pref_dir_project_private_area", getRMapsMainDir(mCtx, "project/private/area").getAbsolutePath(), "");
	}
