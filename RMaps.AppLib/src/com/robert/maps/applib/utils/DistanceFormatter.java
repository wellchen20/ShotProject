...
public class DistanceFormatter {
	...
	public String formatDistance(double dist) {
		final String[] str = formatDistanceBase(dist);
		return str[0]+" "+str[1];
	}

	public String[] formatDistanceBase(double dist) {
	...
	public String formatSpeed(double speed) { // m/s
		final String[] str = formatSpeedBase(speed);
		return str[0]+" "+str[1];
	}
	
	public String[] formatSpeedBase(double speed) { // m/s
		final String[] str = new String[2];
		if(mUnits == 0) {
