...
public class TrackStatHelper {
	...
	public void addPoint(Location pt) {
		addPoint(pt.getLatitude(), pt.getLongitude(), pt.getAltitude(), pt.getSpeed(), pt.getTime());
	}
	...
	public void addPoint(double lat, double lon, double alt, double speed, long dateTime) {
		Cnt++;
