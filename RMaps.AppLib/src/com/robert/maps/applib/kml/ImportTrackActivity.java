...
public class ImportTrackActivity extends Activity {
	...
	private void initViews() {
		...
		.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (selectedFile == null) {
					DialogUtils.alertInfo(ImportTrackActivity.this, getResources().getString(R.string.reminder), "请先选择导入轨迹文件");
				} else {
					doImportTrack(selectedFile);// 导入兴趣点
				}
			}
		});
		...
		((TextView) findViewById(R.id.tv_title_title)).setText("轨迹导入");
	}
