...
public class Track implements PoiConstants {
	...
	public String Name;
	public String Descr;
	public TrackPoint LastTrackPoint; // 堆积最后一个点
	public boolean Show;
	public int Cnt;
	...
	private List<TrackPoint> trackpoints = null; // 轨迹所有点
	...
	public Track() {
		this(EMPTY_ID, "", "", false, 0, 0, 0, 0, 0, 0, "", "");
	}
	
	public Track(final String style) {
		this(EMPTY_ID, "", "", false, 0, 0, 0, 0, 0, 0, style, style);
	}
	
	public Track(final int id, final String name, final String descr, final boolean show, final int cnt,
			final double distance, final double duration, final int category, final int activity, final long date,
	...
	public void CalculateStat() {
		...
		Duration = 0;
		if (trackpoints.size() > 0)
			Duration = (double) ((trackpoints.get(trackpoints.size() - 1).date - trackpoints.get(0).date) / 1000);
