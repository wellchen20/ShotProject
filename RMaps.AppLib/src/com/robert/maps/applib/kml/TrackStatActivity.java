	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (id >= 0) {
        	...
        	if (tr != null){
        		...
        		((TextView)findViewById(R.id.avgspeed_data)).setText(mDf.formatSpeedBase(stat.AvgSpeed)[0]);
        		...
        		((TextView)findViewById(R.id.maxspeed_data)).setText(mDf.formatSpeedBase(stat.MaxSpeed)[0]);
        		((TextView)findViewById(R.id.movetime_data)).setText(sdf.format(new Date((long) (stat.MoveTime))));
        		((TextView)findViewById(R.id.moveavgspeed_data)).setText(mDf.formatSpeedBase(stat.AvgMoveSpeed)[0]);
