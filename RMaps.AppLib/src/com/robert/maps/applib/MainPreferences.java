...
public class MainPreferences extends PreferenceActivity implements OnSharedPreferenceChangeListener, PrefConstants {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mainPreferences = getSharedPreferences("sysconfig", MODE_PRIVATE);
		...
		if(sdf.equalsIgnoreCase("NO")) {
			...
			editor.putString("pref_dir_project", Ut.getExternalStorageDirectory()+"project");
			editor.putString("pref_dir_project_public", Ut.getExternalStorageDirectory()+"project/public");
			editor.putString("pref_dir_project_private", Ut.getExternalStorageDirectory()+"project/private");
			editor.putString("pref_dir_project_private_points", Ut.getExternalStorageDirectory()+"project/private/points");
			editor.putString("pref_dir_project_private_points_input", Ut.getExternalStorageDirectory()+"project/private/points/input");
			editor.putString("pref_dir_project_private_points_output", Ut.getExternalStorageDirectory()+"project/private/points/output");
			editor.putString("pref_dir_project_private_tracks",Ut.getExternalStorageDirectory()+"project/private/tracks");
			editor.putString("pref_dir_project_private_tracks_input", Ut.getExternalStorageDirectory()+"project/private/tracks/input");
			editor.putString("pref_dir_project_private_tracks_output", Ut.getExternalStorageDirectory()+"project/private/tracks/output");
			editor.commit();
		}
...
//		findPreference("pref_dir_export").setSummary(aPref.getString("pref_dir_export", Ut.getExternalStorageDirectory()+"/rmaps/export/"));
		...
		findPreference("pref_tilesize2").setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
			
			@Override
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				preference.getEditor().putString(preference.getKey(), newValue.toString()).commit();
				TileSourceBase.MAPTILE_SIZEPX = Integer.valueOf(newValue.toString());
				mainPreferences.edit().putInt("tilesize", TileSourceBase.MAPTILE_SIZEPX).commit();
				return false;
			}
		});
