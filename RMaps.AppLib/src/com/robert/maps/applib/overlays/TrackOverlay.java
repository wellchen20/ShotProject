...
public class TrackOverlay extends TileViewOverlay {
	...
	public TrackOverlay(Context context, PoiManager poiManager, Handler aHandler) {
...
//				c.drawLine(screenCoords.x - 5, screenCoords.y - 5, screenCoords.x + 5, screenCoords.y + 5, mPaints[i]);
//				c.drawLine(screenCoords.x - 5, screenCoords.y + 5, screenCoords.x + 5, screenCoords.y - 5, mPaints[i]);
			}
		c.restore();
	}
