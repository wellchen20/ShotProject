...
//	}
	...
	public DrillMenuInfo mDrillMenuInfo = new DrillMenuInfo(-1);
	
	public class DrillMenuInfo implements ContextMenuInfo {
		public int MarkerIndex;
		public GeoPoint EventGeoPoint;
		public double Elevation;
		public String stationNo;

		public DrillMenuInfo(int markerIndex) {
			super();
			MarkerIndex = markerIndex;
		}
	}

	public ArrangeMenuInfo mArrangeMenuInfo = new ArrangeMenuInfo(-1);

	public class ArrangeMenuInfo implements ContextMenuInfo {
		public int MarkerIndex;
		public GeoPoint EventGeoPoint;
		public double Elevation;
		public String stationNo;

		public ArrangeMenuInfo(int markerIndex) {
			super();
			MarkerIndex = markerIndex;
		}
	}
	
	public ShotMenuInfo mShotMenuInfo = new ShotMenuInfo(-1);
	
	public class ShotMenuInfo implements ContextMenuInfo {
		public int MarkerIndex;
		public GeoPoint EventGeoPoint;
		public double Elevation;
		public String stationNo;

		public ShotMenuInfo(int markerIndex) {
			super();
			MarkerIndex = markerIndex;
		}
	}

	public AlarmMenuInfo mAlarmMenuInfo = new AlarmMenuInfo(-1);

	public class AlarmMenuInfo implements ContextMenuInfo {
		public int MarkerIndex;
		public GeoPoint EventGeoPoint;
		public AlarmPoint mAlarmPoint;
		public double Elevation;
		...
		public AlarmMenuInfo(int markerIndex) {
			super();
			MarkerIndex = markerIndex;
		}
	}

	public SetMenuInfo mSetMenuInfo = new SetMenuInfo(-1);

	public class SetMenuInfo implements ContextMenuInfo {
		public int MarkerIndex;
		public GeoPoint EventGeoPoint;
		public OnlineSetEntity mOnlineSetEntity;
		public double Elevation;
		public String stationNo;

		public SetMenuInfo(int markerIndex) {
			super();
			MarkerIndex = markerIndex;
		}
	}
