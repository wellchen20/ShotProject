...
//    private String mLogFileName;
	...
	private void handleCommand(Intent intent) {
		...
		final int minTime = Integer.parseInt(pref.getString("pref_trackwriter_mintime", "1000"));
		final int minDistance = Integer.parseInt(pref.getString("pref_trackwriter_mindistance", "5"));
...
//		mNotification.setLatestEventInfo(this, getText(R.string.remote_service_started), text, mContentIntent);
	...
	private class SampleLocationListener implements LocationListener {
		public void onLocationChanged(final Location loc) {
			if (loc != null) {
//			if (loc != null && LocationConform.isConform(loc)) {
