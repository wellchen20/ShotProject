...
import com.jpkh.utils.zbar.camera.CameraManager;
import com.jpkh.utils.zbar.decode.MainHandler;
import com.jpkh.utils.zbar.utils.BeepManager;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private void activityResult(String result) {
        if (!isFinishing()) {
            Log.e("resultString", "resultString: "+result);
            Intent resultIntent = new Intent();
            resultIntent.putExtra("resultString", result);
