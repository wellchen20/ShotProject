package com.jpkh.utils.zxing.camera;
...
import com.jpkh.utils.zxing.decoding.CaptureActivityHandler;
import com.jpkh.utils.zxing.decoding.InactivityTimer;
import com.jpkh.utils.zxing.decoding.RGBLuminanceSource;
import com.jpkh.utils.zxing.view.ViewfinderView;
...
public class MipcaActivityCapture extends Activity implements Callback , View.OnClickListener{
	...
	private void onResultHandler(String resultString, Bitmap bitmap){
		if(TextUtils.isEmpty(resultString)){
			Toast.makeText(MipcaActivityCapture.this, "请选择正确的二维码文件!", Toast.LENGTH_SHORT).show();
			return;
		}
...
//		Toast.makeText(MipcaActivityCapture.this, resultString, Toast.LENGTH_SHORT).show();
		...
		resultIntent.putExtra("stationNo",stationNo);
